package ir.am3n.needtool.platekeyboard.keyboard.controllers

import android.view.inputmethod.InputConnection


open class DefaultKeyboardController(inputConnection: InputConnection): KeyboardController(inputConnection) {
